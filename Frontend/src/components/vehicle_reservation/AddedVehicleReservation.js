    ...
    return (
        <div>
            ...
            <Grid container spacing={3}>
                {vehicleReservations
                    .filter(reservation => reservation.vehicleId) // Filter out reservations without vehicle details
                    .map(reservation => (
                        <Grid item xs={12} sm={6} md={4} key={reservation._id}>
                            <Card>
                                ...
                                <Typography variant="h6">
                                    ...
                                    <Typography variant="h6">
                                        Vehicle Type: {reservation.vehicleId.vehicleType}
                                    </Typography>
                                    <Typography variant="h6">
                                        Vehicle ID: {reservation.vehicleId.registrationNumber}
                                    </Typography>
