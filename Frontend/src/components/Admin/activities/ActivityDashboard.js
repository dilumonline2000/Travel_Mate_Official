...
const categories = [
  { title: 'Add Activities', link: '/admin/activity/add', image: '/addHotel.jpg' },
  { title: 'View Activities', link: '/admin/add/activity', image: '/ViewHotel.jpg' },
];
