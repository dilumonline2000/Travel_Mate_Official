...
import UserBookings from './components/ticket_booking/UserBookings';
...
import HotelOwnerList from './components/hotel/HotelOwnerList'
import HotelDetails from './components/hotel/HotelDetails';

import SpecialBookings from './components/special_activities/UserBookings'
import PackageView from './components/Admin/tour/PackageView';
import OrderList from './components/tour_packages/OrderList';
...
function App() {
  return (
      ...
      {/* User and Admin Authentication routes */}
        ...
        <Route path="/admin/manage/tours" element={<PackageView />} />
        ...
        <Route path="/hotel/view" element={<HotelOwnerList />} />
        ...
        <Route path="/user-booked" element={<SpecialBookings />} />
